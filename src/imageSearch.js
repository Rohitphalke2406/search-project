...
const ImageSearch = () => {
  ...
  return (
    <>
      <h1 className="text-5xl text-center  uppercase mb-10 text-slate-600 underline my-3">
        Image Search App
      </h1>
      <div className="container my-0 mx-auto text-center flex  mt-5">
        <div className="w-2/3 ml-10">
          <div className="flex items-center mb-5">
            ...
            />
            <button
              className="py-2 px-5 text-xl bg-pink-400 text-white rounded-lg cursor-pointer ml-2.5 hover:bg-pink-900 flex items-center"
          ...
          {imageUrl && (
            <div className="mt-5">
              <div style={{ position: "relative", display: "inline-block" }}>
                <img
                  className="max-w-full h-80 rounded-md w-80"
                  src={imageUrl}
                  alt="Searched Image"
                />
                <button
                ...
                >
                  <FaHeart
                    className={`text-2xl ${
                      isFavorite ? "text-pink-500" : "text-grey"
                    }`}
                  />
                </button>
              </div>
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="mt-5  justify-start bg-green-400 hover:bg-green-700 text-white flex items-center font-bold py-2 px-4 rounded"
                >
